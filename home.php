        ...
        <div class="video-background">
            ...
            <div class="row">
                ...
                <div class="col-md-4 d-flex">
                    <div class="card">
                        <div class="card fixed-height">
                            <img src="https://i0.wp.com/images-prod.healthline.com/hlcmsresource/images/News/food-fads/060115_organic_THUMB_LARGE.jpg?w=350&h=150" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title">Organic Selection</h5>
                                <p class="card-text">Our organic range features products that are free from chemicals and pesticides for a healthier lifestyle.</p>
                                <a href="#" class="btn btn-success">Explore</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4 d-flex">
                    <div class="card fixed-height">
                        <div class="card">
                            <img src="https://pluspack.com/wp-content/uploads/2018/07/3boxes-ready2cook-2.jpg?w=350&h=150" class="card-img-top" alt="...">
                            <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="testimonial d-flex flex-column h-100">
                    <blockquote>
                        <p>"Fast N Fresh has been a game-changer for my family. Their produce is always fresh, and their ready-to-cook meals are delicious and easy to prepare."</p>
                    </blockquote>
